...
1. Before committing, run `npm test`.
    - This will reformat your code and run lint checks, in addition to both Node.js-based and browser-based tests.
...
1. Commit your changes.
    ...
    - A pre-commit hook will run which automatically formats your code changes.
